import { TestType, type MovementTest } from "$lib/types/test";
...
export const movementTest: MovementTest = {
	...
	targetPosition: 0,
	prompt: "Remove the special character ('*', '#', '@', etc.) from the buffer.",
	tip: "Tip: move around using hjkl keys or use `/` as well.",
